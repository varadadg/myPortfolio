  ...
  return (
    <div className="flex justify-center w-full">
      ...
      <div className="xs:grid   grid-cols-1 gap-2 sm:grid grid-cols-1 gap-2  justify-center md:grid grid-cols-1 gap-2  justify-center   lg:flex ">
        ...
        <div className="lg:w-96 2xl:mt-[23rem] xl:mt-[22rem]    lg:mt-[14rem] md:-mt-[4rem] xs:w-64 xs:h-64 xs:-mt-[1.9rem] bg-contain bg-center xs:place-self-center sm:w-72 sm:h-72   overflow-hidden">
          <img
            src={myImage}
